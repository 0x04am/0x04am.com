...
The host had to be aggressively dumb for any of this to work, and that part I cannot take credit for. JR did the heaviest lifting on the extension platform and the host-side surgery that made it possible, including the work that finally got the host to stop assuming anything about what a plugin was for. One commit message from that stretch still makes me smile: *"lego-block sidecar, total modality neutralization."* That's the moment the host stopped having a personality.
